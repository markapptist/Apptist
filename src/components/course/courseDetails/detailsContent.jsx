...
const DetailsContent = ({course}) => {
    ...
    const [wishlist, toggleWishList] = useState("heart");
            ...
            <div className="col-lg-8">
              ...
              <div className="card instructor-sec">
                <div className="card-body">
                  ...
                  <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate vero laudantium numquam labore excepturi praesentium molestias quis natus quibusdam illo distinctio eum, maiores harum sapiente obcaecati vitae eaque quasi autem!
                  </p>
                  <p>
                    Dolorem error, velit aperiam harum animi sequi iste quasi voluptatibus. Earum perspiciatis harum minima vel! Odit quaerat eos, libero nesciunt corporis quos non quasi iste, minus aliquid eveniet! Iure, aspernatur officia sed aperiam molestias nulla, iste quam tenetur, tempore dolorum atque error. Accusamus aperiam earum, impedit corporis, sed quibusdam, nobis ullam perspiciatis mollitia quidem debitis quasi nam doloribus suscipit sit totam non illum doloremque soluta! Qui suscipit architecto saepe sed maxime mollitia alias voluptate temporibus.
                  </p>
                  <p>Available for:</p>
                  <ul>
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      >
                        ...
                        <img className="" src={course.imageUrl} alt="" />
                      </Link>
                      <div className="video-details">
                        <div className="course-fee">
                          <h2>${course.amount/2}</h2>
                          <p>
                            <span>${course.amount}</span> 50% off
                          </p>
                        </div>
                        <div className="row gx-2">
                          <div className="col-md-6 addHeart">
                            <div
                              ...
                              onClick={()=>{
                                if(wishlist=="check") toggleWishList("heart")
                                else toggleWishList("check");
                                console.log(wishlist);
                              }}
                            >
                              {/* <i className="feather-heart" />  */}
                              <FeatherIcon icon={wishlist}/>
                              Add to Wishlist
                            </div>
                          </div>
                          <div className="col-md-6 addHeart">
